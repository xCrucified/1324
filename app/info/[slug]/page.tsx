...
"faq": {
  ...
  "content": [
    "Питання: Скільки часу займає доставка?\nВідповідь: Терміни доставки залежать від продавця, країни відправлення та обраного способу доставки. Орієнтовний термін доставки вказується під час оформлення замовлення та може змінюватися залежно від роботи логістичних служб.",
    "Питання: Чи можу я скасувати замовлення?\nВідповідь: Замовлення можна скасувати лише до моменту його передачі продавцем до служби доставки. Якщо замовлення вже відправлено, його скасування може бути неможливим.",
    "Питання: Що робити, якщо товар пошкоджений або не відповідає опису?\nВідповідь: Зверніться до служби підтримки Pentu24 протягом 14 календарних днів після отримання замовлення, додавши фотографії товару та опис проблеми. Ми розглянемо звернення та запропонуємо відповідне рішення.",
    "Питання: Чи можна повернути товар?\nВідповідь: Через особливості міжнародної доставки повернення товарів належної якості не здійснюється. У випадку браку, пошкодження або отримання неправильного товару кожне звернення розглядається індивідуально.",
    "Питання: Які способи оплати підтримуються?\nВідповідь: Ми приймаємо оплату банківськими картками Visa, MasterCard та іншими способами оплати, доступними під час оформлення замовлення. Усі платежі здійснюються через захищених платіжних провайдерів."
  ]
},
  "contact-us": {
